...
if __name__ == "__main__":
    ...
    elif cfg.MODEL.METHOD == "patch":
        print("using patch method")
        acc = PATCH.train_target(cfg)
    
    elif cfg.MODEL.METHOD == "co_learn":
        print("using co-learn method")
        acc = CO_LEARN.train_target(cfg)
